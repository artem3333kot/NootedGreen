...
void DYLDPatches::wrapCsValidatePage(vnode *vp, memory_object_t pager, memory_object_offset_t page_offset,
	...
	//CoreDisplay assertion bypass - Sonoma 14.x (masked rel32 offsets)
	//CoreDisplay_CreateDisplayForCGXDisplayDevice: NOP jne to __assert_rtn
	//Pattern: jne +0xA; call rel32; jmp rel32; cmp [rbp-0x140],0; lea rax,[rip+rel32]
	//Mask: ignore call/jmp/lea rel32 operands (vary between macOS builds)
	static const uint8_t f3b_sonoma[]  = {0x75, 0x0A, 0xE8, 0x00, 0x00, 0x00, 0x00, 0xE9, 0x00, 0x00, 0x00, 0x00, 0x83, 0xBD, 0xC0, 0xFE, 0xFF, 0xFF, 0x00, 0x48, 0x8D, 0x05, 0x00, 0x00, 0x00, 0x00};
	static const uint8_t f3b_fmask[]   = {0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0xFF, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00};
	static const uint8_t r3b_sonoma[]  = {0x90, 0x90, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
	static const uint8_t r3b_rmask[]   = {0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
	...
	//Mask: ignore rip-relative offset in stack canary load (varies between builds)
	static const uint8_t f_skipac_sonoma[]  = {0x55, 0x48, 0x89, 0xe5, 0x41, 0x57, 0x41, 0x56, 0x41, 0x55, 0x41, 0x54, 0x53, 0x48, 0x81, 0xec, 0xd8, 0x01, 0x00, 0x00, 0x48, 0x8b, 0x05, 0x00, 0x00, 0x00, 0x00, 0x48, 0x8b, 0x00, 0x48, 0x89, 0x45, 0xd0};
	static const uint8_t f_skipac_fmask[]   = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x00, 0x00, 0x00, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF};
	static const uint8_t r_skipac_sonoma[]  = {0xC3, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
	static const uint8_t r_skipac_rmask[]   = {0xFF, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
    ...
    if (getKernelVersion() >= KernelVersion::Ventura) {
        ...
        if (allowMetal) {
            ...
            const DYLDPatch patches[] = {
                {f3b_sonoma, f3b_fmask, r3b_sonoma, r3b_rmask, "CoreDisplay assertion bypass (Sonoma)"},
            };
            DYLDPatch::applyAll(patches, const_cast<void *>(data), PAGE_SIZE);
        } else {
            const DYLDPatch patches[] = {
                ...
                {f_skipac_sonoma, f_skipac_fmask, r_skipac_sonoma, r_skipac_rmask, "AccessComplete skip (Sonoma)"},
            };
            DYLDPatch::applyAll(patches, const_cast<void *>(data), PAGE_SIZE);
        }
    }
